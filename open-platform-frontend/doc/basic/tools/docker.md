...
https://prakhar.me/docker-curriculum/#dockerfiles
...
Increase the memory size of your docker-machine instance to at least 2gb.
Do an SSH in your docker-machine instance by docker-machine ssh and run this command sysctl -w vm.max_map_count=262144. This will fix the max virtual memory areas error.
...
What is Docker
A beginner's guide to deploying production web apps
